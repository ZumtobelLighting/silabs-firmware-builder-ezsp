...
# Gecko SDK 4.0.2
RUN \
    curl -o gecko_sdk_4.0.2.zip -L https://github.com/SiliconLabs/gecko_sdk/releases/download/v4.0.2/gecko-sdk.zip \
    && unzip -q -d gecko_sdk_4.0.2 gecko_sdk_4.0.2.zip \
    && rm gecko_sdk_4.0.2.zip
